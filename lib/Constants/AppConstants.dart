...
class AppConstants {
  ...
  header({String text,@required context}){
    ...
    return Container(
      padding: EdgeInsets.only(left: text == AppStrings.confirmationText||text ==AppStrings.bookingText||text ==AppStrings.activityText ?0: 13, right: 20),
      child: Row(
        children: [
          Visibility(
            visible: text == AppStrings.confirmationText||text ==AppStrings.bookingText||text ==AppStrings.activityText ? false:true,
            child: InkWell(
              onTap: (){
